<template>
  <li class="nav-item">
    ...
    >{{ currentUser ? "Logout " + currentUser : 'Admin Login' }}</b-btn>
    ...
    >
      ...
      <b-form>
        <b-form-group horizontal label="Username" label-for="username">
          <b-form-input
            id="admin-username"
          ...
          />
          <b-form-invalid-feedback id="usernameLiveFeedback">Username required</b-form-invalid-feedback>
        </b-form-group>
        <b-form-group horizontal label="Password" label-for="password">
          <b-form-input
            type="password"
            id="admin-password"
          ...
          />
          <b-form-invalid-feedback id="passwordLiveFeedback">Password required</b-form-invalid-feedback>
        </b-form-group>
      </b-form>
    </b-modal>
  </li>
...
export default {
  ...
  methods: {
    ...
    handleOk(event) {
      ...
      let promise = this.$http.post("/admin_login.json", {
        admin_user_session: params
      });
